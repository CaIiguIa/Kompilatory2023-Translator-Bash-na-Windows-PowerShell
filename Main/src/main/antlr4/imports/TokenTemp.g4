...
/* done */block:  L_PARENTH_ROUND list R_PARENTH_ROUND
...
/* done */until:  UNTIL_LOOP_BEGIN list SPLITTER_END_COMMAND LOOP_MIDDLE list SPLITTER_END_COMMAND LOOP_END SPLITTER_END_COMMAND
    ;

/* done */if: IF_START SPLITTER_ID list SPLITTER_END_COMMAND SPLITTER_ID IF_MIDDLE SPLITTER_ID list SPLITTER_END_COMMAND (SPLITTER_ID ELSE_IF SPLITTER_ID list SPLITTER_END_COMMAND SPLITTER_ID IF_MIDDLE SPLITTER_ID list SPLITTER_ID)* (ELSE list SPLITTER_END_COMMAND SPLITTER_ID)? IF_END
    ;

/* done */function:   ID SPLITTER_ID L_PARENTH_ROUND R_PARENTH_ROUND (return_output)?
